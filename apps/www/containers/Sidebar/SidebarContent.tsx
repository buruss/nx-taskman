...
interface Props {
  setPathName,themeType, navStyle, pathname, intl
}
        ...
        <div className="gx-sidebar-content">
          ...
          <CustomScrollbars className="gx-layout-sider-scrollbar">
            <Menu
              ...
              <MenuItemGroup key="main" className="gx-menu-group" title={intl.formatMessage({id: "sidebar.main"})}>
                ...
                <Menu.Item key="main/widgets">
                  <Link href="/main/widgets">
                    <a><i className="icon icon-widgets"/>
                      <IntlMessages id="sidebar.widgets"/></a></Link>
                </Menu.Item>

                <Menu.Item key="main/metrics">
                  <Link href="/main/metrics">
                    <a><i className="icon icon-apps"/>
                      <IntlMessages id="sidebar.metrics"/></a></Link>
                </Menu.Item>

                <Menu.Item key="main/layouts">
                  <Link href="/main/layouts">
                    <a><i className="icon icon-card"/>
                      <IntlMessages id="sidebar.layouts"/></a></Link>
                </Menu.Item>
              ...
              <MenuItemGroup key="in-built-apps" className="gx-menu-group"
                ...
                <Menu.Item key="in-built-apps/mail">
                  <Link href="/in-built-apps/mail">
                    <a><i className="icon icon-email"/>
                      <IntlMessages id="sidebar.mailApp"/></a></Link>
                </Menu.Item>

                <Menu.Item key="in-built-apps/todo">
                  <Link href="/in-built-apps/todo">
                    <a> <i className="icon icon-check-square-o"/>
                      <IntlMessages id="sidebar.todoApp"/></a></Link>
                </Menu.Item>

                <Menu.Item key="in-built-apps/contacts">
                  <Link href="/in-built-apps/contacts">
                    <a><i className="icon icon-contacts"/>
                      <IntlMessages id="sidebar.contactsApp"/></a></Link>
                </Menu.Item>

                <Menu.Item key="in-built-apps/chat">
                  <Link href="/in-built-apps/chat">
                    <a> <i className="icon icon-chat-bubble -flex-column-reverse"/>
                      <IntlMessages id="sidebar.chatApp"/></a></Link>
                </Menu.Item>
              </MenuItemGroup>

              <MenuItemGroup key="social-apps" className="gx-menu-group" title={intl.formatMessage({id: "sidebar.social"})}>
                <Menu.Item key="social-apps/profile">
                  <Link href="/social-apps/profile">
                    <a> <i className="icon icon-profile2"/>
                      <IntlMessages id="sidebar.extensions.profile"/></a>
                  </Link>
                </Menu.Item>
                ...
                <Menu.Item key="social-apps/wall">
                  <Link href="/social-apps/wall">
                    <a> <i className="icon icon-avatar -flex-column-reverse"/>
                      <IntlMessages id="sidebar.wall"/></a>
                  </Link>
                </Menu.Item>
              </MenuItemGroup>

              <MenuItemGroup key="components" className="gx-menu-group" title={intl.formatMessage({id: "sidebar.components"})}>
                ...
                <SubMenu key="general" className={this.getNavStyleSubMenuClass(navStyle)} title={
                  ...
                  <Menu.Item key="components/general/button">
                    <Link href="/components/general/button">
                      <a><IntlMessages id="sidebar.general.button"/></a>
                    </Link>
                  </Menu.Item>
                  <Menu.Item key="components/general/icon">
                    <Link href="/components/general/icon">
                      <a> <IntlMessages id="sidebar.general.icon"/></a></Link>
                  </Menu.Item>
                </SubMenu>
                ...
                <SubMenu key="table" className={this.getNavStyleSubMenuClass(navStyle)}
                  ...
                  <Menu.Item key="components/table/basic">
                    <Link href="/components/table/basic">
                      <a><IntlMessages id="sidebar.view.basicTable"/></a></Link>
                  </Menu.Item>
                  <Menu.Item key="components/table/data">
                    <Link href="/components/table/data">
                      <a> <IntlMessages id="sidebar.view.dataTable"/></a></Link>
                  </Menu.Item>
                </SubMenu>
                ...
                <SubMenu key="editor" className={this.getNavStyleSubMenuClass(navStyle)}
                  ...
                  <Menu.Item key="extra-components/editor/ck">
                    <Link href="/extra-components/editor/ck">
                      <a> <IntlMessages id="sidebar.editors.CKEditor"/></a></Link>
                  </Menu.Item>
                  <Menu.Item key="extra-components/editor/wysiswyg">
                    <Link href="/extra-components/editor/wysiswyg">
                      <a> <IntlMessages id="sidebar.editors.WYSISWYGEditor"/></a></Link>
                  </Menu.Item>
                </SubMenu>
                ...
                <Menu.Item key="extra-components/color-picker">
                  <Link href="/extra-components/color-picker">
                    <a> <i className="icon icon-picker"/>
                      <IntlMessages id="sidebar.pickers.colorPickers"/></a>
                  </Link>
                </Menu.Item>
                ...
                <Menu.Item key="extra-components/dnd">
                  <Link href="/extra-components/dnd">
                    <a> <i className="icon icon-drag-and-drop"/>
                      <IntlMessages id="sidebar.extensions.dragNDrop"/></a>
                  </Link>
                </Menu.Item>
                ...
                <Menu.Item key="extra-components/sweet-alert">
                  <Link href="/extra-components/sweet-alert">
                    <a> <i className="icon icon-sweet-alert"/>
                      <IntlMessages id="sidebar.extensions.sweetAlert"/></a>
                  </Link>
                </Menu.Item>

                <Menu.Item key="extra-components/notification">
                  <Link href="/extra-components/notification">
                    <a><i className="icon icon-notification"/>
                      <IntlMessages id="sidebar.extensions.notification"/></a></Link>
                </Menu.Item>
                ...
                <SubMenu key="eCommerce" className={this.getNavStyleSubMenuClass(navStyle)}
                  ...
                  <Menu.Item key="custom-views/eCommerce/product-grid">
                    <Link href="/custom-views/eCommerce/product-grid">
                      <a> <IntlMessages id="sidebar.eCommerce.productGrid"/></a></Link>
                  </Menu.Item>
                  <Menu.Item key="custom-views/eCommerce/product-list">
                    <Link href="/custom-views/eCommerce/product-list">
                      <a> <IntlMessages id="sidebar.eCommerce.productList"/></a></Link>
                  </Menu.Item>
                </SubMenu>
                ...
                <SubMenu key="errorPages" className={this.getNavStyleSubMenuClass(navStyle)}
                  ...
                  <Menu.Item key="custom-views/error-pages/error-404">
                    <Link href="/custom-views/error-pages/error-404">
                      <a> <IntlMessages id="sidebar.extraPages.404"/></a></Link>
                  </Menu.Item>
                  <Menu.Item key="custom-views/error-pages/error-500">
                    <Link href="/custom-views/error-pages/error-500">
                      <a> <IntlMessages id="sidebar.extraPages.500"/></a></Link>
                  </Menu.Item>
                </SubMenu>
                ...
                <SubMenu key="extra-elements" className={this.getNavStyleSubMenuClass(navStyle)}
                  ...
                  <Menu.Item key="custom-views/extras/pricing-table">
                    <Link href="/custom-views/extras/pricing-table">
                      <a> <IntlMessages id="sidebar.extraElements.pricingTable"/></a></Link>
                  </Menu.Item>

                  <Menu.Item key="custom-views/extras/callouts">
                    <Link href="/custom-views/extras/callouts">
                      <a> <IntlMessages id="sidebar.extraElements.callouts"/></a></Link>
                  </Menu.Item>
                  <Menu.Item key="custom-views/extras/testimonials">
                    <Link href="/custom-views/extras/testimonials">
                      <a> <IntlMessages id="sidebar.extraElements.testimonials"/></a></Link>
                  </Menu.Item>
                </SubMenu>
...
export default connect(mapStateToProps, {setPathName})(injectIntl(SidebarContent));
