...
function* createUserWithEmailPassword({payload}: {type: typeof SIGNUP_USER; payload: any}) {
...
function* signInUserWithEmailPassword({payload}: {type: typeof SIGNIN_USER; payload: any}) {
  const {email, password} = payload;
  try {
